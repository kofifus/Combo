...
ctor();return{focus,select,options,getInputElement,getSelectElement,getWrapper,get value(){return inp.value},set value(val){inp.value=val},set onchange(f){changeFunc=f},set oninput(f){inputFunc=f},set onkeydown(f){keydownFunc=f},set onblur(f){blurFunc=f},}}
